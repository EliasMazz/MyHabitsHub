...
object YoloColorPrimitives {
    ...
    const val Ink50 = 0xFFFAF9F8 // GM N98 — light surface/background
    const val Ink100 = 0xFFF5F7FA // surfaceContainerLow (derived ladder step)
    const val Ink150 = 0xFFF0F4F9 // surfaceContainer, measured 4x
    const val Ink200 = 0xFFEAEFF5 // surfaceContainerHigh, measured chart track
    const val Ink250 = 0xFFE4E9EF // surfaceContainerHighest (derived ladder step)
    const val Ink300 = 0xFFDADDE0 // surfaceDim, measured inactive-day circle
    ...
    const val Ink800 = 0xFF1A1C1E // light onSurface, measured x3
    ...
    const val Deep50 = 0xFF343535 // GM N22 — surfaceBright/Highest dark
    ...
    const val Deep300 = 0xFF1A1A1C // surfaceContainerLow dark (derived ladder step)
    ...
    const val Brand1000 = 0xFF003732 // steps icon circle (dark)
    const val Brand900 = 0xFF00514B // steps chip main (dark)
    const val Brand800 = 0xFF016B5B // map route stroke — Progress light accent
    const val Brand700 = 0xFF08655F // activity icon glyph (light)
    const val Brand600 = 0xFF009688 // step bars (Material teal 500)
    const val Brand500 = 0xFF41DDD0 // goal-met bars
    const val Brand300 = 0xFF93F4EA // steps chip text (dark)
    const val Brand200 = 0xFFBBFCF4 // Fitness tag chip fill (light)
    const val Brand100 = 0xFFCCEAEC // activity icon chip fill (light)
    ...
    const val GreenContainerLight = 0xFFBFEFBB // measured status chips
    const val GreenOnContainerLight = 0xFF085226 // measured
    ...
    const val CobaltWashLight = 0xFFEAF1FB // measured Health canvas (borrowed, spec §10.3)
    const val CobaltSheetLight = 0xFFE0E9F8 // derived
    const val CobaltWashDark = 0xFF131314 // measured hero wash — dark worlds are neutral
    const val CobaltSheetDark = 0xFF1E1F20 // measured nested card
    const val CobaltChipDark = 0xFF004A77
    const val CobaltVariantLight = 0xFF44474F // derived blue-cast NV30
    const val CobaltVariantDark = 0xFFC4C7C5

    // Violet (Settings world — the reference app Sleep purple)
    const val Violet700 = 0xFF5A2E8E // measured Sleep tag text
    const val Violet300 = 0xFFD0BCFF // M3 baseline P80 (no dark purple accent in imagery)
    const val Violet100 = 0xFFEADDFF // M3 baseline P90, measured within noise
    const val Violet150 = 0xFFEADDFF
    const val VioletDeep = 0xFF381E72 // M3 baseline P20
    const val VioletDarkContainer = 0xFF5B2F90 // measured dark Sleep tag pill
    const val VioletContainerOn = 0xFFEFDBFF // measured
    const val VioletWashLight = 0xFFF0F0FA // measured Sleep canvas
    const val VioletSheetLight = 0xFFE7E3F8 // derived
    const val VioletWashDark = 0xFF131314
    const val VioletSheetDark = 0xFF1E1F20
    const val VioletChipDark = 0xFF5B2F90
    const val VioletVariantLight = 0xFF49454F // M3 baseline NV30
    const val VioletVariantDark = 0xFFC4C7C5

    // Teal-world (Progress section) washes/sheets — measured Fitness canvas family
    const val BrandWashLight = 0xFFE5F4F7 // measured Fitness canvas
    const val BrandSheetLight = 0xFFD9EDF0 // derived
    const val BrandChipLight = 0xFFBBFCF4 // measured Fitness tag chip
    const val BrandWashDark = 0xFF131314 // dark worlds are neutral (spec §4.4)
    const val BrandVariantLight = 0xFF3F4946 // derived teal-cast NV30
