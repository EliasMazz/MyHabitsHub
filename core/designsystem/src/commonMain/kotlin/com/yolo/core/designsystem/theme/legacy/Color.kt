package com.yolo.core.designsystem.theme.legacy
    ...
    data class TextInput(
        ...
        companion object {
            val DefaultLight = TextInput(
                textIcon = Color.PRIMARY_DEFAULT_LIGHT,
    ...
    data class Text(
        ...
        companion object {
            val DefaultLight = Text(
                primary = Color.PRIMARY_DEFAULT_LIGHT,
                secondary = Color.SECONDARY_DEFAULT_LIGHT
            )
            val DefaultDark = Text(
                primary = Color.PRIMARY_DEFAULT_DARK,
                secondary = Color.SECONDARY_DEFAULT_DARK
            )
        }
    }
    ...
    data class BottomNav(
        ...
        companion object {
            val DefaultLight = BottomNav(
                ...
                selectedTextIcon = Color.PRIMARY_DEFAULT_LIGHT,
                unselectedTextIcon = Color.SECONDARY_DEFAULT_LIGHT
            )
            val DefaultDark = BottomNav(
                background = Color.BLACK_1_HEX_18,
                selectedTextIcon = Color.PRIMARY_DEFAULT_DARK,
                unselectedTextIcon = Color.SECONDARY_DEFAULT_DARK
            )
        }
    }
}
...
val lightModeAppColors = AppColors(
    ...
    alternative = Color.SECONDARY_DEFAULT_LIGHT,
    onAlternative = Color.PRIMARY_DEFAULT_LIGHT,
